...
// mess.
	...
	public:
		...
		verifier& with_custom_claim(const typename json_traits::string_type& name, const typename json_traits::string_type&  c) {
			claims[name] = basic_claim_t(c);
			return *this;
		}
		/**
